...
const Footer = () => (
  ...
  <Flex margin="auto" marginTop="2em" maxW="container.lg" justify="space-between" p={3} borderTopWidth='1px' borderTopRadius='lg' display={["none", "flex", "flex", "flex"]} fontSize={["xs", "xs", "sm", "sm"]}>
    ...
    <HStack>
      <Link href="https://twitter.com/protonxpr" isExternal alignItems={'center'}><Image alt="twitter-logo" src="twitter-logo.svg" w="20px" h="20px" m={1}/></Link>
      <Link href="https://t.me/protonxpr" isExternal alignItems={'center'}><Image alt="telegram-logo" src="telegram-logo.svg" w="20px" h="20px" m={1}/></Link>
    </HStack>
  </Flex>
